...
class SqliteNews : Sqlite
{
	...
	//INSERT INTO news VALUES (NULL, 0, 0, "Race Analyzer kit", "Kit Analizador Carreras", "https://chronojump.org/shop/races/race_analyzer_kit/race-analyzer/", "https://chronojump.org/es/shop/carreras/kit_analizador_carreras/analizador-de-carrera/", "Measure the instantaneous race speed.\n\n- Encoder based (included)\n- Distance accuracy: 3 cm\n- Time accuracy: 4 microseconds\n\nIdeal device for high accuracy analysis of the sprint applicable in the field and in many sports disciplines!", "Mida la velocidad instantánea.\n\n- Usa un encoder (incluído)\n- Precisión en la distancia: 3 cm\n- Precisión en el tiempo: 4 microseg.\n\n¡Dispositivo ideal para un análisis de alta precisión del sprint aplicable en el campo y en muchas disciplinas deportivas!", "https://chronojump.org/wp-content/uploads/2020/12/Race-Analyzer_new_products_400w.jpeg");
