...
CHRONOJUMP_DEP_GUI = src/gui/confirm.cs src/gui/error.cs src/gui/jump.cs src/gui/jumpType.cs src/gui/person.cs src/gui/preferences.cs src/gui/session.cs src/gui/stats.cs
