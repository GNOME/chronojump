...
#CONSTANTS
my $currentVersion = "0.8";
my $currentVersionDay = "2";
my $currentVersionMonth = 12; #if it's from 1 to 9, put only one digit
my $currentVersionYear = "2008";
my $linuxMailDownloadLink = "http://ftp.gnome.org/pub/GNOME/binaries/linux/chronojump/Chronojump-0.8-Linux-x86-Install";
my $linuxMailDownloadName = "Chronojump 0.8 Linux";
my $windowsMailDownloadLink = "http://ftp.gnome.org/pub/GNOME/binaries/win32/chronojump/Chronojump-0.8-Windows-Install.exe";
my $windowsMailDownloadName = "Chronojump 0.8 Windows";
...
my $changesMailDownloadLink = "http://mail.gnome.org/archives/chronojump-list/2008-December/msg00001.html";
