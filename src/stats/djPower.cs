...
public class StatDjPower : Stat
{
	...
	public override string ToString () 
	{
		...
		return string.Format(Catalog.GetString("{0} in Dj Power [mass * g * (fallHeight + 1.22625 * (tf^2) ) / tc] applied to {1} on {2}"), selectedValuesString, jumpType, mySessionString);
	}
}
