...
*/
	...
	*/ //what is this height?
	...
	public static string FfmpegNotInstalled = string.Format(Catalog.GetString("Error. {0} is not installed."), "ffmpeg");
	public static string MplayerClosed = string.Format(Catalog.GetString("Error. {0} has been closed."), "mplayer");
	public static string MplayerCannotSave = string.Format(Catalog.GetString("Error. {0} cannot save video."), "mplayer");
