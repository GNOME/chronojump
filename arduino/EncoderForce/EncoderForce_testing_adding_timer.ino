...
// timer variables
//int freq = 10000; //this works when isolated but fails now in EncoderForce
int freq = 500;
volatile bool flagA = false;
hw_timer_t *timerA = NULL;
volatile int timerPrintCount = 1000000;
...
void loop() {
  if (flagA)
  {
    Serial.print(timerPrintCount);
    Serial.print(";");
    Serial.println(1); //the encoderPosition (1 or -1 if pps == 1)
    
    // this is NOT better:
    //Serial.println(String(timerPrintCount) + ";1");
