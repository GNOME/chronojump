...
Source: "./dist.chronojump-x64/*"; Excludes: ".gitignore"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs    
...
Source: "./installers/dotnet-runtime-7.0.14-win-x64.exe"; DestDir: "{app}\installers\"
Source: "./installers/python-3.12.0-amd64.exe"; DestDir: "{app}\installers\"
...
[Run]
Filename: "{app}\installers\dotnet-runtime-7.0.14-win-x64.exe"; StatusMsg: "Install .NET Runtime 7.0.14"; Tasks: install_dotnet7; Flags: skipifsilent
Filename: "{app}\installers\python-3.12.0-amd64.exe"; StatusMsg: "Install Python 3.12.0"; Tasks: install_python3; Flags: skipifsilent
