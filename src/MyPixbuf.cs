...
namespace Chronojump
{
    ...
    internal static class MyPixbuf
    {
        ...
        static List<ResourceFix> resourceFix_l = new List<ResourceFix> {
			...
			new ResourceFix ("platform_connect_300.jpg" , "platform_connect_300.jpg"),
			new ResourceFix ("platform_stand_300.jpg" , "platform_stand_300.jpg"),
			...
			new ResourceFix ("menu_blue.png" , "image_menu_blue.png"),
			new ResourceFix ("menu_yellow.png" , "image_menu_yellow.png"),
			...
			new ResourceFix ("bluetooth_settings.png" , "bluetooth_settings.png"),
			new ResourceFix ("thumb_up.png" , "thumb_up.png"),
			new ResourceFix ("thumb_down.png" , "thumb_down.png"),
			new ResourceFix ("refresh_blue.png" , "refresh_blue.png"),
