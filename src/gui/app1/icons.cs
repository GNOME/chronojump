...
public partial class ChronoJumpWindow 
{
	...
	Gtk.Image image_prefs_util_help_blue;
	Gtk.Image image_prefs_util_help_yellow;
	...
	Gtk.Image image_ai_ab_options;
	Gtk.Image image_signal_analyze_move_cd_close;
	Gtk.Image image_ai_ab_options_close;
	...
	private void putNonStandardIcons()
	{
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_menu_blue.png");
		image_menu_prefs_util_help.Pixbuf = pixbuf;
		image_menu_prefs_util_help1.Pixbuf = pixbuf;
		image_prefs_util_help_blue.Pixbuf = pixbuf;
		image_jumps_profile_sjl_help.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_menu_yellow.png");
		image_prefs_util_help_yellow.Pixbuf = pixbuf;
		...
		image_resultsSession_force_max.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "encoder-analyze-max.png");
		image_resultsSession_force_best_second.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "best-second.png");
		...
		app1s_image_show_data_fourPlatforms.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "fourPlatforms_blue_24px.png");
		...
		image_menu_utilities.Pixbuf = pixbuf;
		...
		image_ai_ab_options.Pixbuf = pixbuf;
		...
		image_ai_ab_options_close.Pixbuf = pixbuf;
		...
		*/
		...
		image_force_sensor_adjust_no_capturing.Pixbuf = pixbuf;
		...
		*/
		...
		image_button_finish2.Pixbuf = pixbuf;
		...
		image_race_analyzer_show_accel.Pixbuf = pixbuf;
		...
		image_race_analyzer_show_force.Pixbuf = pixbuf;
		...
		image_race_analyzer_show_power.Pixbuf = pixbuf;
		...
		image_results_session_zoom.Pixbuf = pixbuf;
	...
	private void connectWidgetsIcons (Gtk.Builder builder)
	{
		...
		image_prefs_util_help_blue = (Gtk.Image) builder.GetObject ("image_prefs_util_help_blue");
		image_prefs_util_help_yellow = (Gtk.Image) builder.GetObject ("image_prefs_util_help_yellow");
		...
		image_ai_ab_options = (Gtk.Image) builder.GetObject ("image_ai_ab_options");
		image_signal_analyze_move_cd_close = (Gtk.Image) builder.GetObject ("image_signal_analyze_move_cd_close");
		image_ai_ab_options_close = (Gtk.Image) builder.GetObject ("image_ai_ab_options_close");
