...
par(new=T)
plot(speedSerie$y, type="l", col="green", lty=1)
lines(speedSessio$y, col="green", lty=2)

abline (v=propulsiveEndSerie, lty=1)
abline (v=propulsiveEndSessio, lty=2)

par(new=T)
plot(accelSerie$y, type="l", col="magenta", lty=1)
lines(accelSessio$y, col="magenta", lty=2)
...
par(new=T)
plot(powerSerie, type="l", col="red", lty=1)
lines(powerSessio, col="red", lty=2)
dev.off()
