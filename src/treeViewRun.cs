...
public class TreeViewRunsInterval : TreeViewRuns
{
	...
	protected override System.Object getObjectFromString(string [] myStringOfData) {
		...
		runType = SqliteGeneral.SqliteRunIntervalType.SelectAndReturnRunIntervalType(myRunI.Type, SqliteGeneral.Sqlite.IsOpened);
	...
	protected override string [] getSubLineToStore(System.Object myObject, int lineCount)
	{
		...
		if(newRunI.DistanceInterval == -1) {
			runType = SqliteGeneral.SqliteRunIntervalType.SelectAndReturnRunIntervalType(newRunI.Type, SqliteGeneral.Sqlite.IsOpened);
